  ...
  */
  /*
    ...
    403 (Forbidden)    → o usuário ESTÁ autenticado, só não tem
                          ...
                          (ex.: usuário comum tentando uma rota de admin,
                          ou uma chamada de admin que falhou por outro
                          motivo). Isso NÃO deve deslogar ninguém —
                          era exatamente isso que estava derrubando o
                          admin ao criar um filme.
